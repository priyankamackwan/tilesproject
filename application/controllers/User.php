				...
				foreach ($q as $key=>$value)
				{
					...
					$nestedData['status'] = $statusText;
                                        if ($value->status == 0) {
											...
											$nestedData['manage'] = '<a href="'.$view.'" style="padding: 8px;margin-top:1px;" class="btn btn-info   btn-xs "  title="View" data-toggle="tooltip"><i class="fa fa-eye"></i></a>&nbsp;<a class="btn btn-sm btn-primary" href="'.$accept.'" style="padding: 8px;margin-top:1px;" data-toggle="tooltip" title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>&nbsp;<a href="'.$statusAction.'" class="btn btn-warning btn-xs confirm-statuschange" style="padding: 8px;margin-top:1px;" data-toggle="tooltip" title="Block"><i class="fa fa-ban"></i></a>&nbsp;<a href="'.$delete.'" style="padding: 8px;margin-top:1px;" class="btn btn-danger btn-xs confirm-delete-user" data-toggle="tooltip" title="Delete"><i class="fa fa-trash"></i></a>';
                                        } elseif ($value->status == 2) {
											...
											$nestedData['manage'] = '<a href="'.$view.'" style="padding: 8px;margin-top:1px;" class="btn btn-info   btn-xs "  title="View"><i class="fa fa-eye"></i></a>&nbsp;<a style="padding: 8px;margin-top:1px;" href="'.$delete.'" class="btn btn-danger btn-sm confirm-delete" data-toggle="tooltip" title="Delete"><i class="fa fa-trash"></i></a>';
                                        }
					$data[] = $nestedData;
                                        $srNo++;
				}
