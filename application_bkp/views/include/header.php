              ...
              <div class="menu_section">
                <ul class="nav side-menu">
                    <?php if ($this->userhelper->current('role_id') == 1) { ?>
                        ...
                        <li><a href="<?php echo base_url();?>User"><i class="fa fa-user"></i>Clients</a></li>
                        <?php } if (in_array('4',$this->userhelper->current('rights'))) { ?>
                        <li><a href="<?php echo base_url();?>Category"><i class="fa fa-tag"></i>Category</a></li>
                         <li><a href="<?php echo base_url();?>Subcategory"><i class="fa fa-tag"></i>Sub Category</a></li>
                        <?php } if (in_array('5',$this->userhelper->current('rights'))) { ?>
                        <li><a href="<?php echo base_url();?>Product"><i class="fa fa-tag"></i>Products</a></li>
                        <?php } if (in_array('6',$this->userhelper->current('rights'))) { ?>
                        <li><a href="<?php echo base_url();?>Order"><i class="fa fa-tag"></i>Orders</a></li>
                        <?php } ?>
                </ul>
              </div>
            </div>
